...
`ifndef VSYN_SIM 
  ...
  begin
    ...
    $readmemh("rtl_tb/inst.pat", mem_inst_temp);
    $readmemh("rtl_tb/data.pat", mem_data_temp);
	...
	//Owen	tb.x_soc.x_axi_slave128.x_f_spsram_large.ram0.mem[2097151:0]
`ifdef RTL_SIM
      	$writememh("dut_ram0.txt", `RTL_MEM.ram0.mem);
      	$writememh("dut_ram1.txt", `RTL_MEM.ram1.mem);
      	$writememh("dut_ram2.txt", `RTL_MEM.ram2.mem);
      	$writememh("dut_ram3.txt", `RTL_MEM.ram3.mem);
      	$writememh("dut_ram4.txt", `RTL_MEM.ram4.mem);
      	$writememh("dut_ram5.txt", `RTL_MEM.ram5.mem);
      	$writememh("dut_ram6.txt", `RTL_MEM.ram6.mem);
      	$writememh("dut_ram7.txt", `RTL_MEM.ram7.mem);
      	$writememh("dut_ram8.txt", `RTL_MEM.ram8.mem);
      	$writememh("dut_ram9.txt", `RTL_MEM.ram9.mem);
      	$writememh("dut_ram10.txt", `RTL_MEM.ram10.mem);
      	$writememh("dut_ram11.txt", `RTL_MEM.ram11.mem);
      	$writememh("dut_ram12.txt", `RTL_MEM.ram12.mem);
      	$writememh("dut_ram13.txt", `RTL_MEM.ram13.mem);
      	$writememh("dut_ram14.txt", `RTL_MEM.ram14.mem);
      	$writememh("dut_ram15.txt", `RTL_MEM.ram15.mem);
`endif
...
initial begin
`ifdef USE_GALAXSIM
	$xedbDumpfile("Tb.xedb");
	$xedbDumpvars(0,Tb,"+mda");
`else
	$fsdbDumpfile("Tb.fsdb");
